...
flowchart TD
  Start --&gt; Stop
\`\`\`
</pre><p>效果如下</p>`,9),T=e(`<p><strong>默认开启</strong>，可以通过<code>mermaid</code>进行进一步配置，或关闭</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-siSeU" id="tab-c07t_9w" checked="checked"><label for="tab-c07t_9w">① 关闭</label><input type="radio" name="group-siSeU" id="tab-daCSXOK"><label for="tab-daCSXOK">② 进一步配置</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">blogTheme</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">getThemeConfig</span><span style="color:#E1E4E8;">({</span></span>
...
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">})</span></span></code></pre></div></div></div><p>下面看一下官方其它案例</p><p><strong>时序图</strong></p>`,4),S=a("p",null,[a("strong",null,"甘特图")],-1);function F(P,D,B,w,V,N){const p=i("PluginTabs"),o=i("Mermaid");return l(),E("div",null,[b,n(p,{tabLabels:["tab1","tab2"]},{tab1:s(()=>[h,m,_]),tab2:s(()=>[g]),_:1}),u,n(p,{tabLabels:["a","b"],sharedStateKey:"ab"},{a:s(()=>[A]),b:s(()=>[C]),_:1}),n(p,{tabLabels:["a","b"],sharedStateKey:"ab"},{a:s(()=>[v]),b:s(()=>[f]),_:1}),k,(l(),t(r,null,{default:s(()=>[n(o,{id:"mermaid-66",graph:"flowchart%20TD%0A%20%20Start%20--%3E%20Stop%0A"})]),fallback:s(()=>[c(" Loading... ")]),_:1})),T,(l(),t(r,null,{default:s(()=>[n(o,{id:"mermaid-80",graph:"sequenceDiagram%0AAlice-%3E%3EJohn%3A%20Hello%20John%2C%20how%20are%20you%3F%0Aloop%20Healthcheck%0A%20%20%20%20John-%3E%3EJohn%3A%20Fight%20against%20hypochondria%0Aend%0ANote%20right%20of%20John%3A%20Rational%20thoughts!%0AJohn--%3E%3EAlice%3A%20Great!%0AJohn-%3E%3EBob%3A%20How%20about%20you%3F%0ABob--%3E%3EJohn%3A%20Jolly%20good!%0A"})]),fallback:s(()=>[c(" Loading... ")]),_:1})),S,(l(),t(r,null,{default:s(()=>[n(o,{id:"mermaid-84",graph:"gantt%0A%20%20%20%20section%20Section%0A%20%20%20%20Completed%20%3Adone%2C%20%20%20%20des1%2C%202014-01-06%2C2014-01-08%0A%20%20%20%20Active%20%20%20%20%20%20%20%20%3Aactive%2C%20%20des2%2C%202014-01-07%2C%203d%0A%20%20%20%20Parallel%201%20%20%20%3A%20%20%20%20%20%20%20%20%20des3%2C%20after%20des1%2C%201d%0A%20%20%20%20Parallel%202%20%20%20%3A%20%20%20%20%20%20%20%20%20des4%2C%20after%20des1%2C%201d%0A%20%20%20%20Parallel%203%20%20%20%3A%20%20%20%20%20%20%20%20%20des5%2C%20after%20des3%2C%201d%0A%20%20%20%20Parallel%204%20%20%20%3A%20%20%20%20%20%20%20%20%20des6%2C%20after%20des4%2C%201d%0A"})]),fallback:s(()=>[c(" Loading... ")]),_:1}))])}const q=d(y,[["render",F]]);export{J as __pageData,q as default};
