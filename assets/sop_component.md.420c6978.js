...
flowchart TD
  Start --&gt; Stop
\`\`\`
</pre><p>效果如下</p>`,9),T=e(`<p><strong>默认开启</strong>，可以通过<code>mermaid</code>进行进一步配置，或关闭</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-XZudm" id="tab-6uLyiBs" checked="checked"><label for="tab-6uLyiBs">① 关闭</label><input type="radio" name="group-XZudm" id="tab-ynSq7VN"><label for="tab-ynSq7VN">② 进一步配置</label></div><div class="blocks"><div class="language-ts vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">blogTheme</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">getThemeConfig</span><span style="color:#E1E4E8;">({</span></span>
