import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.d53bf09d.js";const h=JSON.parse('{"title":"Vue 插槽 (slot) 的实现原理","description":"Vue 插槽 (slot) 的实现原理","frontmatter":{"description":"Vue 插槽 (slot) 的实现原理","layout":"doc","tag":["vue"],"prev":{"text":"vue目录","link":"/vue-md/"},"next":{"text":"arco更换主题包","link":"/vue-md/arco-theme.md"}},"headers":[],"relativePath":"vue-md/vue-slot.md","filePath":"vue-md/vue-slot.md","lastUpdated":null}'),p={name:"vue-md/vue-slot.md"},o=l(`<h1 id="vue-插槽-slot-的实现原理" tabindex="-1">Vue 插槽 (slot) 的实现原理 <a class="header-anchor" href="#vue-插槽-slot-的实现原理" aria-label="Permalink to &quot;Vue 插槽 (slot) 的实现原理&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>大家好，我是你们的友好邻居 Talon ，想必大家都用过 Vue 的插槽吧，用过的人都说好用，没用过的人建议用一用，那么这个插槽到底是怎么实现的，我们今天就来一探究竟。</p><h2 id="插槽的工作原理与实现" tabindex="-1">插槽的工作原理与实现 <a class="header-anchor" href="#插槽的工作原理与实现" aria-label="Permalink to &quot;插槽的工作原理与实现&quot;">​</a></h2><p>顾名思义，组件的插槽指组件会预留一个槽位，该槽位具体要渲 染的内容由用户插入，如下面给出的 <code>MyComponent</code> 组件的模板所 示：</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
